...
class RenderLandmarks extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawPoints(PointMode.points, points_red, paint);
  }
...
//     //, List<int> included, bool isCorrect
//     for (List<dynamic> point in inferenceList) {
//       if ((point[2] > 0.40)) {
//         //& included.contains(inferenceList.indexOf(point))
//         points_red
//             .add(Offset(point[0].toDouble() - 70, point[1].toDouble() - 30));
//         // isCorrect
//         //     ? points_green
...
//           edge_red); //isCorrect ? edge_green : edge_red);
//       // }
//     }
//   }
// }
